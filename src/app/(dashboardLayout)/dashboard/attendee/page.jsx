...
const AttendeePage = () => {
    ...
    return (
        <div className="space-y-8 p-5">
            ...
            <Card className="glass border-white/5 max-w-3xl mx-auto" radius="lg">
                ...
                <div className="pt-6">
                    <Form className="space-y-4 w-full flex flex-col">
                        ...
                        <Button
                            ...
                            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold h-11 px-6 shadow-lg shadow-indigo-500/10 hover:shadow-indigo-500/20"
                            radius="lg"
                        >
                            Save Profile
                        </Button>
